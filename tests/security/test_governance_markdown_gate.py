...
def test_governance_markdown_gate_passes(monkeypatch, tmp_path: Path) -> None:
    ...
    mp.write_text(
        json.dumps({"title": "t", "owner": "o", "version": "1", "last_reviewed_utc": "2026-03-04T00:00:00+00:00"})
        + "\n",
        encoding="utf-8",
    )
        ...
        json.dumps(
            {
                "documents": [
                    {
                        "path": "governance/security/THREAT_MODEL.md",
                        "metadata_path": "governance/security/metadata/THREAT_MODEL.meta.json",
                        "signature_path": "governance/security/metadata/THREAT_MODEL.meta.json.sig",
                    }
                ]
            }
        )
