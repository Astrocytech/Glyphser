...
REQUIRED_SNIPPETS = {
    ".github/workflows/ci.yml": [
        ...
        "python tooling/security/sarif_upload_prerequisite_gate.py",
        "python tooling/security/sarif_fallback_upload_gate.py",
        "python tooling/security/workflow_upload_wildcard_gate.py",
        ...
        "python tooling/security/signature_key_lineage_policy_gate.py",
