...
def main() -> int:
    ...
    required_docs = [
        first_existing([rel("product", "handbook", "GA_SUPPORT_MATRIX.md"), rel("docs", "product", "GA_SUPPORT_MATRIX.md")]),
        first_existing([rel("product", "handbook", "GA_MIGRATION_GUIDE.md"), rel("docs", "product", "GA_MIGRATION_GUIDE.md")]),
        first_existing([rel("product", "handbook", "GA_SUPPORT_LIFECYCLE.md"), rel("docs", "product", "GA_SUPPORT_LIFECYCLE.md")]),
        first_existing([rel("product", "handbook", "GA_STATUS_INCIDENT_COMMUNICATION.md"), rel("docs", "product", "GA_STATUS_INCIDENT_COMMUNICATION.md")]),
        first_existing([rel("product", "handbook", "GA_RELEASE_TRAIN_POLICY.md"), rel("docs", "product", "GA_RELEASE_TRAIN_POLICY.md")]),
        first_existing([rel("product", "handbook", "GA_CONTRACTUAL_SUPPORT_SLA.md"), rel("docs", "product", "GA_CONTRACTUAL_SUPPORT_SLA.md")]),
        first_existing([rel("product", "handbook", "GA_GO_NO_GO_CHECKLIST.md"), rel("docs", "product", "GA_GO_NO_GO_CHECKLIST.md")]),
        first_existing([rel("product", "handbook", "COMPLIANCE_EVIDENCE_INDEX.md"), rel("docs", "product", "COMPLIANCE_EVIDENCE_INDEX.md")]),
        first_existing([rel("product", "handbook", "DEPENDENCY_LICENSE_REVIEW.md"), rel("docs", "product", "DEPENDENCY_LICENSE_REVIEW.md")]),
        first_existing([rel("product", "handbook", "GA_COMPATIBILITY_GUARANTEES.md"), rel("docs", "product", "GA_COMPATIBILITY_GUARANTEES.md")]),
        first_existing([rel("product", "handbook", "POST_GA_GOVERNANCE.md"), rel("docs", "product", "POST_GA_GOVERNANCE.md")]),
        first_existing([rel("product", "handbook", "ACCESSIBILITY_REVIEW.md"), rel("docs", "product", "ACCESSIBILITY_REVIEW.md")]),
        first_existing([rel("product", "handbook", "SUPPLY_CHAIN_TRUST_POLICY.md"), rel("docs", "product", "SUPPLY_CHAIN_TRUST_POLICY.md")]),
        first_existing([rel("product", "handbook", "PRIVACY_IMPACT_ASSESSMENT_WORKFLOW.md"), rel("docs", "product", "PRIVACY_IMPACT_ASSESSMENT_WORKFLOW.md")]),
        first_existing([rel("product", "handbook", "DOCS_VERSIONING_POLICY.md"), rel("docs", "product", "DOCS_VERSIONING_POLICY.md")]),
        first_existing([rel("product", "handbook", "CHANGE_COMMUNICATION_SLA.md"), rel("docs", "product", "CHANGE_COMMUNICATION_SLA.md")]),
        first_existing([rel("product", "handbook", "ANNUAL_SECURITY_REVIEW_POLICY.md"), rel("docs", "product", "ANNUAL_SECURITY_REVIEW_POLICY.md")]),
        first_existing([rel("product", "handbook", "GA_SIGNOFF.md"), rel("docs", "product", "GA_SIGNOFF.md")]),
        first_existing([rel("product", "handbook", "GA_SUPPORT_OPERATIONS_READINESS.md"), rel("docs", "product", "GA_SUPPORT_OPERATIONS_READINESS.md")]),
    ]
    required_artifacts = [
