...
See `specs/layers/L1-foundation/Determinism-Profiles.md` for technical details.

## Canonical Serialization Rules
- All hashed artifacts MUST use canonical CBOR as defined in `specs/layers/L1-foundation/Data-Representation.md`.
...
- Non-finite values (NaN, +/-Infinity) are disallowed unless explicitly stated in `specs/policies/NUMERIC_POLICY_v0.1.md`.
...
- Replay tokens MUST be derived from a deterministic, ordered set of inputs:
  ...
  - Trace event index
- The exact input set and order MUST match `specs/layers/L1-foundation/Determinism-Profiles.md`.
