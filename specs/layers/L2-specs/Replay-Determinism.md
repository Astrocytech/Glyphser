...
- `env_manifest_hash` is computed per `specs/layers/L1-foundation/Environment-Manifest.md` (alias `runtime_env_hash` must resolve to same bytes32).
...
**Purity class:** PURE  
**Determinism:** deterministic  
**Definition:** compares trace fields under declared determinism class rules using `specs/layers/L2-specs/Trace-Sidecar.md` schema, active determinism profile, and the selected comparison profile from Section II.I:
