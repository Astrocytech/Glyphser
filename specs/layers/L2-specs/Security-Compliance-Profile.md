...
- Access governance:
  ...
  - authorization decision hash:
    ...
    - definitions and canonical field semantics are normative as specified in `specs/layers/L2-specs/AuthZ-Capability-Matrix.md` section II.G.
...
- Regulated-mode trace redaction binding:
  ...
  - field-level transformation rules must conform to `specs/layers/L1-foundation/Redaction-Policy.md`.
