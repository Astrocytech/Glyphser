...
- Run/access-plan identity:
  - `world_size_policy = "rank_contiguous_shard"` (must match `specs/layers/L2-specs/Data-NextBatch.md`).
  - `epoch_seed_rule = "epoch_seed_rule"` (must match `specs/layers/L2-specs/Data-NextBatch.md`).
