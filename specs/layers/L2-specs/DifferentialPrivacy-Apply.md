...
- `security.differential_privacy`:
  ...
  - `sampling_mode: string` (from `specs/layers/L2-specs/Data-NextBatch.md` sampler metadata)
...
- Accountant assumptions must match sampler behavior declared in `specs/layers/L2-specs/Data-NextBatch.md`.
