...
## 7) Trace & Metrics
### Logging rule
- monitoring pipeline emits deterministic `MonitorEvent` records (schema from `specs/layers/L1-foundation/Data-Structures.md`) and optional linked trace entries.
### Trace schema
