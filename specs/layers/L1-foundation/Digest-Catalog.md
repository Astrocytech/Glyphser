...
- Canonical CBOR in this document means `CBOR_CANONICAL` as defined by `specs/layers/L1-foundation/Canonical-CBOR-Profile.md` (single authoritative encoding profile for commitment paths).
