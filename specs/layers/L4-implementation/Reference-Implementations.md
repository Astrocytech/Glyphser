...
- Error handling must map to `specs/layers/L1-foundation/Error-Codes.md` IDs only.
...
- signatures and side-effects must match `specs/layers/L1-foundation/API-Interfaces.md`.
...
- `CBOR_CANONICAL(value)`:
  - encode using `specs/layers/L1-foundation/Canonical-CBOR-Profile.md` (definite lengths, no duplicate keys, key order by `(len(encoded_key), encoded_key)`).
...
**Definition:** canonical sampling pseudocode consistent with `specs/layers/L2-specs/Data-NextBatch.md`.
...
**Definition:** canonical DP pseudocode consistent with `specs/layers/L2-specs/DifferentialPrivacy-Apply.md`.
...
**Purity class:** PURE
**Determinism:** deterministic
**Definition:** canonical comparator pseudocode aligned with `specs/layers/L2-specs/Replay-Determinism.md`.
...
**Purity class:** PURE
**Determinism:** deterministic
**Definition:** canonical evidence-link validation pseudocode aligned with `specs/layers/L2-specs/Execution-Certificate.md`.
