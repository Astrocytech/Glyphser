...
- Lock policy is defined by `specs/layers/L1-foundation/Dependency-Lock-Policy.md`.
- The canonical lockfile name for this project is `requirements.lock`.
- Release bundles must include lockfile hash commitments as required by `specs/layers/L2-specs/Execution-Certificate.md`.
