...
- Operator records sorted by authoritative ordering from `specs/layers/L1-foundation/Operator-Registry-Schema.md` (numeric `version_num` compare for `vN`).
...
- Canonical serialization uses `specs/layers/L1-foundation/Canonical-CBOR-Profile.md`.
...
- Canonical ordering for `operator_records` is inherited from `specs/layers/L1-foundation/Operator-Registry-Schema.md`:
...
- `signature_digest` must match canonical preimage formula from `specs/layers/L1-foundation/Operator-Registry-Schema.md`.
...
- This hash must match `operator_contracts_root_hash` in `specs/layers/L2-specs/Execution-Certificate.md`.
...
- Canonical serialization profile for this preimage is `CanonicalSerialization` from `specs/layers/L1-foundation/Canonical-CBOR-Profile.md`.

---
## 3) Procedure
```text
1. Load operator entries from specs/layers/L1-foundation/API-Interfaces.md and docs/layer4-implementation/Code-Generation-Mapping.md
2. Resolve digest_refs using specs/layers/L1-foundation/Digest-Catalog.md
...
- Cross-check against `specs/layers/L1-foundation/Operator-Registry-Schema.md`.
