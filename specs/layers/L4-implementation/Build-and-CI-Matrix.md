...
- CI workers must satisfy `specs/layers/L1-foundation/Environment-Manifest.md` and lock policy.
...
- `tooling/commands/push_button.py` must run in CI for all changes to `specs/contracts/`, `specs/`, or `tooling/`.
