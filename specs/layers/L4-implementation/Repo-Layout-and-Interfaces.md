...
- `specs/layers/L1-foundation/API-Interfaces.md` and `docs/layer4-implementation/Code-Generation-Mapping.md` are rendered/derived views and must not diverge from the artifact.
